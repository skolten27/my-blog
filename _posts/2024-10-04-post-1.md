...
While this was only a very high level overview, I hope you now understand a little bit better `plotnine`, `matplotlib` and `seaborn` and some of the strengths and weakenesses associated with each package. I'd love to create additional posts exploring these packages and more of their functionality later. Leave a comment letting me know which package you want me to post on first!